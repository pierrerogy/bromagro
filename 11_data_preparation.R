#Data preparation
##Reminder: Run Script #01 beforehand
##Overall mens all observations pooled per tree
##Night/Day means diurnal and nocturnal replicates kept separate per tree
...
# Contrast between leaf chewers and phloem suckers ---------------------
#Make new data frame
observation_rev <- 
  observation
#Change diet string
...
# Remove trees with outstanding number of bromeliads ----------------------
observation_eq <- 
  observation_rev %>% 
  filter(alltrees %notin% c("CP_I7", "CP_I9", "CP_J4"))
...
# Dietary group frames with leaf chewers and phloem suckers separate ------------------------
#For bromeliads
##CP
obsdietcp_rev <-
  observation_rev %>%
...
# Behaviour frames with leaf chewers and phloem suckers for bromeliad-level analysis------------------------
#CP 
##Behaviour duration
...
# Behaviour frames with leaf chewers and phloem suckers for bromeliad-associated predator analysis --------
#CP
##Behaviour duration
...
# Night/Day frames for bromeliad-level analysis with all herbivores--------------------------------------------------------
#Dietary groups
##CP
noctdiet <- 
  observation %>% 
...
# Night/Day frames for bromeliads with leaf chewers and phloem suckers--------------------------------------------------------
#Diet
noctdiet_rev <- 
  observation_rev %>% 
  ungroup() %>% 
...
# Night/Day frames for bromeliads-associated predators with all herbivores --------------------------------------------------------
#Diet
...
# Night/Day frames for bromeliads-associated predators with leaf chewers and phloem suckers --------------------------------------------------------
#Diet
